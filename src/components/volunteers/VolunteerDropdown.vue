<template>
  <li class="relative group">
    ...
    <ul class="absolute right-0 pt-2 hidden group-hover:block hover:block z-50">
      <div class="bg-white text-gray-800 shadow-2xl rounded-lg overflow-hidden w-64 border-2 border-red-600">
        ...
        <li v-for="(item, index) in volunteersMenuItems" :key="item.path">
          ...
          <div v-if="index < volunteersMenuItems.length - 1" class="mx-4 border-b border-gray-200"></div>
        </li>
