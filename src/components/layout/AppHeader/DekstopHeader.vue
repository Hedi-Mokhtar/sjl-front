    ...
    <ul class="flex items-center space-x-3 lg:space-x-4">
      ...
      <li v-for="item in mainNavItems" :key="item.path">
        <RouterLink :to="item.path"
          class="px-4 py-2 rounded-md border-2 border-red-600 dark:border-red-400 text-red-600 dark:text-red-400 hover:bg-red-600 hover:text-white transition-all duration-200 font-semibold">
          {{ item.label }}
        </RouterLink>
      </li>
